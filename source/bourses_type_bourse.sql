...
LOCK TABLES `type_bourse` WRITE;
/*!40000 ALTER TABLE `type_bourse` DISABLE KEYS */;
INSERT INTO `type_bourse` VALUES (0,'INDETERMINE'),(1,'Professeurs et assimilés'),(2,'Maîtres de conférences et assimilés');
/*!40000 ALTER TABLE `type_bourse` ENABLE KEYS */;
UNLOCK TABLES;
